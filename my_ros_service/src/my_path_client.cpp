...
double hafpie = M_PI/2; //This is half of pi
...
int main(int argc, char **argv) {
    ...
    pose.position.x = .30; // say desired x-coord is 1
    pose.position.y = 0.0;
    ...
    pose.orientation.x = 0.0; //always, for motion in horizontal plane
    pose.orientation.y = 0.0; // ditto
    pose.orientation.z = hafpie;
    pose.orientation.w = 1.0; //sum of squares of all components of unit quaternion is 1
    pose_stamped.pose = pose;
    path_srv.request.nav_path.poses.push_back(pose_stamped);

    pose.position.x = .625; // say desired x-coord is 1
    pose.position.y = .3;
    pose.position.z = 0.0; // let's hope so!
    pose.orientation.x = 0.0; //always, for motion in horizontal plane
    pose.orientation.y = 0.0; // ditto
    ...
    pose.position.x = .20; // say desired x-coord is 1
    pose.position.y = 1.10;
    pose.position.z = 0.0; // let's hope so!
    pose.orientation.x = 0.0; //always, for motion in horizontal plane
    pose.orientation.y = 0.0; // ditto
    pose.orientation.z = M_PI;
    pose.orientation.w = 1.0; //sum of squares of all components of unit quaternion is 1
    pose_stamped.pose = pose;
    path_srv.request.nav_path.poses.push_back(pose_stamped);

    pose.position.x = .20; // say desired x-coord is 1
    pose.position.y = 1.20;
    pose.position.z = 0.0; // let's hope so!
    pose.orientation.x = 0.0; //always, for motion in horizontal plane
    pose.orientation.y = 0.0; // ditto
    pose.orientation.z = hafpie; 
